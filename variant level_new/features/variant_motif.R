#This R script is to get motif count based on outside datasource on variant level
library(stringr)
library(dplyr)
library(readxl)
library(readr)
...
LCS_max3 = merge(LCS_max, variants_all, by = "uniprot")
...
#merge the flags back to variants_all by uniprot
variants_all$variant_protein_flag = motif_max3$variant_protein_feature_flag[match(variants_all$uniprot, motif_max3$uniprot)]
variants_all$variant_domain_flag = motif_max3$variant_domains_flag[match(variants_all$uniprot, motif_max3$uniprot)]
variants_all$variant_slim_flag = motif_max3$variant_slim_flag[match(variants_all$uniprot, motif_max3$uniprot)]
variants_all$variant_morf_flag = motif_max3$variant_morf_flag[match(variants_all$uniprot, motif_max3$uniprot)]
variants_all$variant_ptm_flag = motif_max3$variant_ptm_flag[match(variants_all$uniprot, motif_max3$uniprot)]
variants_all$variant_nls_flag = motif_max3$variant_nls_flag[match(variants_all$uniprot, motif_max3$uniprot)]
variants_all$variant_LCS_flag = LCS_max3$variant_LCS_flag[match(variants_all$uniprot, LCS_max3$uniprot)]

write.csv(variants_all, "variants_all_with_motif_LCS_flags.csv", row.names = FALSE)
#select flags
