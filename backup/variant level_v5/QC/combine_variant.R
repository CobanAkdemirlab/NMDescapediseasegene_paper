#variants are selected from same genes, but plp_ptc from clinvar and (benign)_ptc from gnomad, This R script is to combine them into variant_all
library(dplyr)
...
variants_all = read.csv('variants_all.csv')
