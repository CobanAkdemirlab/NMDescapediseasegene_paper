...
summarise_by_group <- function(gene_all, label) {
  ...
  write_csv(desc,     out_file(sprintf("group_summary_%s.csv", label)))
  write_csv(feat_tab, out_file(sprintf("group_features_%s.csv", label)))
...
write_csv(ctrl_snv$matched, out_file("pairs_snv_matched.csv"))
write_csv(ctrl_fs$matched,  out_file("pairs_fs_matched.csv"))
write_csv(ctrl_snv$random,  out_file("pairs_snv_random.csv"))
write_csv(ctrl_fs$random,   out_file("pairs_fs_random.csv"))
...
write_csv(gene_all_matched, out_file(CONFIG$out_matched))
...
write_csv(gene_all_random, out_file(CONFIG$out_random))
