...
motif_max3$protein_flag2 = motif_max3$`Protein Features`*3 >= motif_max3$NMD_region_start
motif_max3$domains_flag = motif_max3$`Domains`*3 >= motif_max3$cds_mutation_loc
motif_max3$domains_flag2 = motif_max3$`Domains`*3 >= motif_max3$NMD_region_start
motif_max3$slim_flag = motif_max3$`SLiMs`*3 >= motif_max3$cds_mutation_loc #variant location on cds scale
motif_max3$slim_flag2 = motif_max3$`SLiMs`*3 >= motif_max3$NMD_region_start
motif_max3$morf_flag = motif_max3$MORFs*3 >= motif_max3$cds_mutation_loc
motif_max3$morf_flag2 = motif_max3$MORFs*3 >= motif_max3$NMD_region_start
motif_max3$ptm_flag = motif_max3$`PTMs`*3 >= motif_max3$cds_mutation_loc
motif_max3$ptm_flag2 = motif_max3$`PTMs`*3 >= motif_max3$NMD_region_start
motif_max3$nls_flag = motif_max3$`NLSs`*3 >= motif_max3$cds_mutation_loc
motif_max3$nls_flag2 = motif_max3$`NLSs`*3 >= motif_max3$NMD_region_start
LCS_max3 = merge(LCS_max, gene_all, by = "uniprot")
LCS_max3$LCS_flag = LCS_max3$`LCSs`*3 >= LCS_max3$cds_mutation_loc
LCS_max3$LCS_flag2 = LCS_max3$`LCSs`*3 >= LCS_max3$NMD_region_start
#filter for AD variants
LCS_max_AD = LCS_max3[which(LCS_max3$transcript %in% omim_AD_symbols_tx$ensembl_transcript_id),]
motif_max3_AD = motif_max3[which(motif_max3$transcript %in% omim_AD_symbols_tx$ensembl_transcript_id),]
write.csv(LCS_max_AD, "gene_LCS_max_AD.csv", row.names = FALSE)
write.csv(motif_max3_AD, "gene_motif_max_AD.csv", row.names = FALSE)
write.csv(LCS_max3, "gene_LCS_max3.csv", row.names = FALSE)
write.csv(motif_max3, "gene_motif_max3.csv", row.names = FALSE)
#select flags
