...
control_variants_all$variant_morf_flag = motif_max3$variant_morf_flag[match(control_variants_all$.vm_row, motif_max3$.vm_row)]
control_variants_all$variant_ptm_flag = motif_max3$variant_ptm_flag[match(control_variants_all$.vm_row, motif_max3$.vm_row)]
control_variants_all$variant_nls_flag = motif_max3$variant_nls_flag[match(control_variants_all$.vm_row, motif_max3$.vm_row)]
control_variants_all$variant_LCS_flag = LCS_max3$variant_LCS_flag[match(control_variants_all$.vm_row, LCS_max3$.vm_row)]
control_variants_all$.vm_row = NULL
