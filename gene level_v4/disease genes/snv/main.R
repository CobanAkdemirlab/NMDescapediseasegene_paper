...
fs_candidate_ind = which(v_ch$Type %in% c('Deletion', 'Insertion', 'Indel', 'Duplication', 'Microsatellite'))
fs_change_frame_ind = which(nchar(v_ch$ReferenceAlleleVCF) != nchar(v_ch$AlternateAlleleVCF))
length(intersect(fs_candidate_ind, fs_change_frame_ind))
