...
res_clinvar_default_1 = readRDS(data_file("clinvar0819_1.rds"))
res_clinvar_default_2 = readRDS(data_file("clinvar0819_2.rds"))
res_clinvar_default_3 = readRDS(data_file("clinvar0819_3.rds"))
