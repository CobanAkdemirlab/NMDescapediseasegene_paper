...
# Data resolved via data_file(); output via out_dir()/out_file()
...
write_csv(tx6, out_file("genes7_canonical_variants.csv"))
...
# ----------------------------
fasta_dir <- out_dir("plus1_fasta_output")
...
# ----------------------------
# out_dir <- out_dir("plus1_fasta_matched")
# dir_create(out_dir)
