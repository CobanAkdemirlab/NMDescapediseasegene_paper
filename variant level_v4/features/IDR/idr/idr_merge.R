...
#mjoin snv_control_uniprot_ids_out to snv_control_idr by gene, the Disordered_Domain_Boundaries in snv_control_uniprot_ids_out
# becomes wildtype_Disordered_Domain_Boundaries in snv_control_idr
