...
pdf(out_file("aa_comp_all_12plots.pdf"), width = 10, height = 6)  # adjust size as needed
...
ggplot(abs_sasa_var_FL, aes(x = group, y = abs_sasa_var_FL, fill = group)) +
  ...
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
ggsave(out_file("sasa_var_FL.png"), plot = last_plot(), width = 8, height = 6)
...
print(p_plddt_FL)
ggsave(out_file("plddt_mean_FL.png"), p_plddt_FL, width = 12, height = 4.5, dpi = 300)
...
print(p_plddt_NMD)
ggsave(out_file("plddt_mean_NMD.png"), p_plddt_NMD, width = 12, height = 4.5, dpi = 300)
...
ggsave(out_file("nmd_length_loss_in_WT.png"),
...
print(p_pI_FL)
ggsave(out_file("pI_FL_faceted.png"), p_pI_FL, width = 12, height = 4.5, dpi = 300)
...
if (has_pI_NMD) {
  ...
  print(p_pI_NMD)
  ggsave(out_file("pI_NMD_faceted.png"), p_pI_NMD, width = 12, height = 4.5, dpi = 300)
...
#8. plot aromaticity# --- Aromaticity plots like pLDDT/pI: WT vs Var × (FL & NMD) ----------------
  ...
  print(p_arom_FL)
  ggsave(out_file("aromaticity_FL_faceted.png"), p_arom_FL, width = 12, height = 4.5, dpi = 300)
  ...
  if (has_arom_NMD) {
    ...
    print(p_arom_NMD)
    ggsave(out_file("aromaticity_NMD_faceted.png"), p_arom_NMD, width = 12, height = 4.5, dpi = 300)
