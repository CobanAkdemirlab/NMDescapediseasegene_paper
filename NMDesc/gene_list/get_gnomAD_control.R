...
#exlude any gene that is in the snv_can list
gene_list2 = gene_list[!gene_list$hgnc_symbol %in% snv_plp_ptc_p1120_NMDenriched2_can$X1,]

snv_NMD_results3.5 = snv_NMD_results[which(snv_NMD_results$transcript %in% gene_list2$ensembl_transcript_id),]
